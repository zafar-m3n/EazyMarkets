...
/**
 * MagicBento
 * - cards are passed in as a prop (no internal defaults)
 * - glow defaults to your theme lime
 */
const MagicBento = ({
  cards = [],
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-2">
          {cards.map((card, index) => {
            ...
            const cardStyle = {
              backgroundColor: card.color || "#0b0f14", // slightly lighter than background for depth
