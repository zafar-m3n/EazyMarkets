    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-120 bg-gradient-conic from-accent-1 via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]"
        >
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-120 bg-gradient-conic from-transparent via-transparent to-accent-1 text-white [--conic-position:from_290deg_at_center_top]"
        >
        ...
        <div className="absolute inset-auto z-50 h-36 w-md -translate-y-1/2 rounded-full bg-accent-1 opacity-50 blur-3xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-24 rounded-full bg-accent-1 blur-2xl"
        ></motion.div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-120 -translate-y-28 bg-accent-1"
        ></motion.div>
