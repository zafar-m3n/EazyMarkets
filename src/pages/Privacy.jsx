        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-18 lg:pt-32 lg:pb-20">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-5 text-sm md:text-base text-text/70 leading-8 max-w-2xl">
              Understand how EazyMarkets collects, uses, stores, and protects your information while you use our website
              and services.
            </motion.p>
          </motion.div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {policySections.map((section) => (
              <PolicySectionCard key={section.title} title={section.title} paragraphs={section.paragraphs} />
            ))}
          </motion.div>
        </div>
      </section>
