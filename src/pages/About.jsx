    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        <div className="flex items-start justify-between gap-4">
          ...
          {number ? (
            <span className="rounded-full border border-accent-1/20 bg-accent-1/12 px-3 py-1 text-xs font-medium tracking-[0.22em] text-accent-2/90">
              {number}
            </span>
          ) : null}
        </div>
        ...
        {stat ? (
          <div className="mt-6 inline-flex w-fit items-center rounded-full border border-border/90 bg-white/72 px-3 py-1.5 text-xs text-text/65">
            {stat}
          </div>
        ) : null}
