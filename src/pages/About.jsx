...
const About = () => {
  ...
  const renderBentoCard = ({ icon, title, description, className = "", stat }) => (
    ...
    >
      ...
      <div className="relative z-10 flex h-full flex-col">
        ...
        <h3 className="mt-5 text-xl md:text-[1.35rem] font-semibold leading-tight">{title}</h3>
        <p className="mt-3 text-sm md:text-[15px] leading-7 text-text/72">{description}</p>
  ...
  return (
    <div ref={scrollContainerRef} className="min-h-screen bg-background text-text font-figtree overflow-x-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <div className="relative overflow-hidden rounded-4xl border border-accent-1/10 bg-card/70 backdrop-blur-md shadow-[0_20px_70px_rgba(0,0,0,0.28)]">
                <img src={aboutHero} alt="About EazyMarkets" className="w-full h-90 md:h-115 object-cover" />
            ...
            <div className="grid lg:grid-cols-[0.9fr_1.1fr] gap-10 items-start">
              ...
              <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.15 }} variants={fadeUp}>
                ...
                <p className="mt-4 text-text/70 leading-8 text-sm md:text-base">
                  Instead of adding complexity, our focus is on intelligent automation, structured execution, and tools
                  that support consistency in fast-moving conditions.
                </p>
              </motion.div>
            </div>
          </div>
      ...
      {/* CTA */}
      <section id="about-cta" className="py-18 md:py-20 relative">
